...
const message_raw_payload_parser_1 = require("./message-raw-payload-parser");
blue_tape_1.default('messageRawPayloadParser', (t) => __awaiter(void 0, void 0, void 0, function* () {
    t.skip('tbw');
    // t.test('text', async t => {
...
blue_tape_1.default('sys', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const PADPLUS_MESSAGE_PAYLOAD_SYS = {
    ...
    const payload = yield message_raw_payload_parser_1.messageRawPayloadParser(PADPLUS_MESSAGE_PAYLOAD_SYS);
    // console.log('payload:', payload)
    t.deepEqual(payload, EXPECTED_MESSAGE_PAYLOAD_SYS, 'should parse sys message payload');
}));
blue_tape_1.default('room invitation created by others', (t) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const payload = yield message_raw_payload_parser_1.messageRawPayloadParser(MESSAGE_PAYLOAD);
    t.deepEqual(payload, EXPECTED_PAYLOAD, 'should parse room invitation message payload');
}));
blue_tape_1.default('room ownership transfer message', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const MESSAGE_PAYLOAD = {
        content: '你已成为新群主',
...
blue_tape_1.default('share card peer to peer', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const MESSAGE_PAYLOAD = {
...
blue_tape_1.default('share card in room', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const MESSAGE_PAYLOAD = {
...
blue_tape_1.default('attachment file with ext .xlsx', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const MESSAGE_PAYLOAD = {
        appMsgType: 6,
...
blue_tape_1.default('others recalled message in room', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const MESSAGE_PAYLOAD = {
...
blue_tape_1.default('bot recalled message in room', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const MESSAGE_PAYLOAD = {
...
blue_tape_1.default('others recalled message in private chat', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const MESSAGE_PAYLOAD = {
        appMsgType: undefined,
    ...
    const payload = yield message_raw_payload_parser_1.messageRawPayloadParser(MESSAGE_PAYLOAD);
    t.deepEqual(payload, EXPECTED_PAYLOAD, 'should parse recalled message in private message');
}));
blue_tape_1.default('bot recalled message in private chat', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const MESSAGE_PAYLOAD = {
        appMsgType: undefined,
...
//   t.deepEqual(payload, EXPECTED_PAYLOAD, 'should parse official account sent url.')
// })
blue_tape_1.default('Transfer money message', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const MESSAGE_PAYLOAD = {
        appMsgType: 2000,
    ...
    const EXPECTED_PAYLOAD = {
        ...
        toId: 'wxid_zovb9ol86m7l22',
        type: wechaty_puppet_1.MessageType.Transfer,
    };
    const payload = yield message_raw_payload_parser_1.messageRawPayloadParser(MESSAGE_PAYLOAD);
