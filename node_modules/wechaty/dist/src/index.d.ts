...
export { ScanStatus, UrlLinkPayload, } from 'wechaty-puppet';
...
export { Contact, Tag, Friendship, Favorite, Message, Moment, Money, Room, RoomInvitation, UrlLink, MiniProgram, } from './user';
